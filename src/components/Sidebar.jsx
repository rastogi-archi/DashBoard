...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <div className="md:hidden p-4 bg-indigo-50 shadow-sm flex items-center justify-between">
      ...
      {isOpen && (
        <div className="md:hidden bg-indigo-50 shadow-lg px-6 py-4 space-y-3 text-gray-700 font-medium">
      ...
      <div className="hidden md:flex w-64 h-screen bg-indigo-50 shadow-xl p-6 flex-col justify-between">
        <div>
          ...
          <nav className="flex flex-col space-y-3 text-gray-700 font-medium">
            <Link to="/" className="px-4 py-2 rounded-lg hover:bg-indigo-100 hover:text-indigo-600 transition">Home</Link>
            <Link to="/profile" className="px-4 py-2 rounded-lg hover:bg-indigo-100 hover:text-indigo-600 transition">Profile</Link>
            <Link to="/settings" className="px-4 py-2 rounded-lg hover:bg-indigo-100 hover:text-indigo-600 transition">Settings</Link>
